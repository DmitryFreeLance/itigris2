...
public class Keyboards {
    public static InlineKeyboardMarkup startMenu() {
        InlineKeyboardButton sub = InlineKeyboardButton.builder()
                .text("📅 Моя подписка").callbackData("MY_SUBSCRIPTION").build();
        InlineKeyboardButton buy = InlineKeyboardButton.builder()
                .text("💳 Оформить подписку").callbackData("BUY_SUBSCRIPTION").build();
        InlineKeyboardButton cancel = InlineKeyboardButton.builder()
                .text("❌ Отменить подписку").callbackData("CANCEL_SUBSCRIPTION").build();
    ...
    public static InlineKeyboardMarkup confirmCancel() {
        InlineKeyboardButton yes = InlineKeyboardButton.builder()
                .text("✅ Да").callbackData("CONFIRM_CANCEL_YES").build();
        InlineKeyboardButton no = InlineKeyboardButton.builder()
                .text("↩️ Нет").callbackData("CONFIRM_CANCEL_NO").build();
        return InlineKeyboardMarkup.builder().keyboard(List.of(List.of(yes, no))).build();
    }

    public static InlineKeyboardMarkup buyButton() {
        InlineKeyboardButton buy = InlineKeyboardButton.builder()
                .text("💳 Оформить подписку").callbackData("BUY_SUBSCRIPTION").build();
        return InlineKeyboardMarkup.builder().keyboard(List.of(List.of(buy))).build();
    }
